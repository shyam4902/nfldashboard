...
### Draft Capital (team roster modal)

The former Draft tab was removed after the 2026 draft. Each team's roster modal now has a **Draft Capital** tab (right of Special Teams) showing 2027/2028 pick holdings from `draft-capital.json`, generated by `scripts/build_draft_capital.py` from the app's transaction ledger. Acquired picks are highlighted with their source team; traded-away rounds are struck through.
